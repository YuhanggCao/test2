...
def _ECMR5(question: Question) -> str:
...
def ECMR5_1(question: Question) -> str:
    _, result = util.translate_to(_ECMR5(question), "Dutch")
    return result.result


def ECMR5_2(question: Question) -> str:
    _, result = util.translate_to(_ECMR5(question), "German")
    return result.result


def ECMR5_3(question: Question) -> str:
    _, result = util.translate_to(_ECMR5(question), "Spanish")
    return result.result


def ECMR5_4(question: Question) -> str:
    _, result = util.translate_to(_ECMR5(question), "French")
    return result.result
