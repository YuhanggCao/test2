...
def QMR2_Spanish(question: Question) -> list[ChatSlice]:
    """
    ...
    chat_slice = QMR2_Spanish_step_1(question)
...
def QMR2_Spanish_step_1(question: Question, prompt: str = "") -> ChatSlice:
    if not prompt:
    ...
    question.QMR2_Spanish = chat_slice.answer
    return chat_slice
