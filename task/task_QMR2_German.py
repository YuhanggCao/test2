...
def QMR2_German(question: Question) -> list[ChatSlice]:
    """
    ...
    chat_slice = QMR2_German_step_1(question)
...
def QMR2_German_step_1(question: Question, prompt: str = "") -> ChatSlice:
    if not prompt:
    ...
    question.QMR2_German = chat_slice.answer
    return chat_slice
